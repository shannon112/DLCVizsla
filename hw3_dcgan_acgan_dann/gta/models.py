...
class _netG(nn.Module):
    def __init__(self):
        ...
        self.ndim = 2*consts.ndf
        self.ngf = consts.ngf
        self.nz = consts.nz

        self.main = nn.Sequential(
            nn.ConvTranspose2d(self.nz+self.ndim+consts.nclasses+1, self.ngf*8, 2, 1, 0, bias=False),
    ...
    def forward(self, input):
        ...
        input = input.view(-1, self.ndim+consts.nclasses+1, 1, 1)
...
class _netD(nn.Module):
    def __init__(self):
        ...
        self.classifier_c = nn.Sequential(nn.Linear(self.ndf*2, consts.nclasses))
...
class _netC(nn.Module):
    def __init__(self):
        ...
        self.main = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Linear(2*self.ndf, consts.nclasses),
        )
