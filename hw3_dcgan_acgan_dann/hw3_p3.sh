...
# bash ./hw3_p3.sh ../hw3_data/digits/usps/test usps ./test_pred.csv
...
if [ $2 == "svhn" ]
then
   model_path="dann/models_MtoS/best.pth"
elif [ $2 == "mnistm" ]
then
  model_path="dann/models_UtoM/best.pth"
elif [ $2 == "usps" ]
then
  model_path="dann/models_StoU/best.pth"
else
   echo "None of the condition met"
fi
python3 dann/predict.py $1 "$model_path" $3
